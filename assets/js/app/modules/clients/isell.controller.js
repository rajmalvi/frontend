app.controller('IsellController', ['$scope', '$rootScope', '$routeParams', '$window', 'FileUploader', '$compile', 'ClientsServices', '$uibModal', '$http', '$location', '$timeout', '$q', 'session', 'uiGridConstants', function ($scope, $rootScope, $routeParams, $window, FileUploader, $compile, ClientsServices, $uibModal, $http, $location, $timeout, $q, session, uiGridConstants) {
    ...
    $scope.renderGrid = function() {
        ...
        var columnDefs = [
                ...
                {name: 'room_available_to_sell', displayName: 'Rooms Available to Sell', width: 100, superCol: 'house_perf', enablePinning:false},
                {name: 'room_available_to_sell_online', displayName: 'Rooms Available to Sell Online', width: 100, superCol: 'house_perf', enablePinning:false},
                {name: 'ota_sold', displayName: 'OTA Sold', width: 100, superCol: 'ota_perf', enablePinning:false},
                {name: 'pickup_from_lr', displayName: 'Pickup from LR', width: 100, superCol: 'ota_perf', enablePinning:false},
                ...
                {name: 'rate_cm', displayName: 'Rate on Channel Manager', width: 150, superCol: 'rate', enablePinning:false},
                {name: 'recommended_rate', displayName: 'Recommended Rate', width: 150, superCol: 'rate', enablePinning:false}
        ];
